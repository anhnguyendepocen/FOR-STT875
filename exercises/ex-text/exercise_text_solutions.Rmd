...
1.  How many lines are in the source file? How many total characters are in the source file? Use R to answer these questions below. (For the second, you will find the `nchar` function, discussed in [Section 11.3.2](https://www.jeffdoser.com/files/for875/_book/xml.html#nchar-and-strsplit), useful.)
