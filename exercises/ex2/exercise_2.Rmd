...
## Overview
Create an R Markdown document that recreates the archetype html document available [here](http://www.finley-lab.com/files/data/exercise_2_archetype.html). Your resulting HTML document should be different from the archetype document in two ways: 
...
## Grading
You will receive full credit if the html document produced from your R Markdown document matches the [archetype](http://www.finley-lab.com/files/data/exercise_2_archetype.html) document (with the two differences noted above).
