...
```
<a name="fig_oil"></a>Map 1: Total, active, and inactive oil and gas wells by USGS hydrologic units across Colorado. You can see a full browser window version of this map [here](http://www.finley-lab.com/files/data/exercise_sp_map1.html).
