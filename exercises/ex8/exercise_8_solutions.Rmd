...
ggplot(gapminder1[gapminder1$year %in% seq(1900, 1990, by=10),], aes(x = year, y = lifeExp)) + geom_boxplot(aes(group = year))

ggplot(gapminder1[gapminder1$year %in% seq(1900, 1990, by=10),], aes(x = factor(year), y = lifeExp)) + geom_boxplot()
```
...
lifeExp_countries <- subset(gapminder1, country %in% countries)
