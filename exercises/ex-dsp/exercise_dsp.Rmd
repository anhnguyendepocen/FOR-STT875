...
7. Include the code `register_google(key = "AIzaSyBPAwSY5x8vQqlnG-QwiCAWQW12U3CTLZY")` to connect to the class project for working with `ggmap`.
8. Use `ggmap`, `ggrepel`, and `ggplot2` to produce the desired map. For the location of the map, use "avon, new york"
