...
3. Choose one of the mirrors.^[The https://cloud.r-project.org/ mirror is usually fast. Otherwise choose a mirror in Michigan.]
...
```{r comic, echo = FALSE, out.width = "100%", fig.cap = "xkcd: Code Quality"}
