...
knitr::include_graphics("../figures/hello_shiny.png")
```
...
```{r, prompt=FALSE}
namesDF <- read.csv("https://www.finley-lab.com/files/data/name_list.csv", 
