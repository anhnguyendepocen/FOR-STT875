...
Bringing data into R, exporting data from R in a form that is readable by other software, cleaning and reshaping data, and other data manipulation tasks are an important and often overlooked component of data science. The book @SpectorDataManipulation, while a few years old, is still an excellent reference for data-related issues, and is available for free at http://catalog.lib.msu.edu/record=b7254984~S39a. And the \emph{R Data Import/Export} manual, available online at https://cran.r-project.org/doc/manuals/R-data.pdf, is an up-to-date (and free) reference on importing a wide variety of datasets into R and on exporting data in various forms.
