...
knitr::include_graphics("../figures/rmarkdownInputOutput.png")
```
...
knitr::include_graphics("../figures/listsPic.png")
```
...
knitr::include_graphics("../figures/headersAndLatex.png")
```
...
knitr::include_graphics(c("../figures/chunks1.png", "../figures/chunks2.png"))
```
