...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{fertility \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{fertility.rate[WorldBank}\OperatorTok{$}\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{1960}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{lifeexp \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{life.expectancy[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{fertility[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{pop \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{population[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{region \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{region[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{pop[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{a \textless{}{-}}\StringTok{ }\DecValTok{1}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{str}\NormalTok{(a)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{is.vector}\NormalTok{(a)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{length}\NormalTok{(a)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{weight \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{123}\NormalTok{, }\DecValTok{157}\NormalTok{, }\DecValTok{205}\NormalTok{, }\DecValTok{199}\NormalTok{, }\DecValTok{223}\NormalTok{, }\DecValTok{140}\NormalTok{, }\DecValTok{105}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gender \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"female"}\NormalTok{, }\StringTok{"female"}\NormalTok{, }\StringTok{"male"}\NormalTok{, }\StringTok{"female"}\NormalTok{, }\StringTok{"male"}\NormalTok{,}
\OperatorTok{+}\StringTok{             "male"}\NormalTok{, }\StringTok{"female"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gender}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{weight \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(weight, }\DecValTok{194}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gender \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(gender, }\StringTok{"male"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{weight}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{typeof}\NormalTok{(weight)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{typeof}\NormalTok{(gender)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{missingCharacter \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"dog"}\NormalTok{, }\StringTok{"cat"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"pig"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"horse"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{missingCharacter}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{missingCharacter \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(missingCharacter, }\StringTok{"NA"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{missingCharacter}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mtcars}\OperatorTok{$}\NormalTok{mpg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mtcars}\OperatorTok{$}\NormalTok{cyl}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mpgHpLinMod}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mpgHpLinMod}\OperatorTok{$}\NormalTok{residuals}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{temporaryList}\OperatorTok{$}\NormalTok{first}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{mode}\NormalTok{(temporaryList}\OperatorTok{$}\NormalTok{first)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{healthData}\OperatorTok{$}\NormalTok{Weight[healthData}\OperatorTok{$}\NormalTok{Gender }\OperatorTok{==}\StringTok{ "male"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{healthData[healthData}\OperatorTok{$}\NormalTok{Gender }\OperatorTok{==}\StringTok{ "female"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{healthData[healthData}\OperatorTok{$}\NormalTok{Weight }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{190}\NormalTok{, }\DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{WorldBank1971 \textless{}{-}}\StringTok{ }\NormalTok{WorldBank[WorldBank}\OperatorTok{$}\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{1971}\NormalTok{, ]}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{dim}\NormalTok{(WorldBank1971)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate[}\DecValTok{1}\OperatorTok{:}\DecValTok{25}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate[}\DecValTok{1}\OperatorTok{:}\DecValTok{25}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{WorldBank1971 \textless{}{-}}\StringTok{ }\NormalTok{WorldBank1971[}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate),]}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{dim}\NormalTok{(WorldBank1971)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ crime, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ burglary, }\DataTypeTok{y =}\NormalTok{ motor\_vehicle\_theft)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{scale\_x\_continuous}\NormalTok{(}\DataTypeTok{name=}\StringTok{"Burglaries per 100,000 population"}\NormalTok{, }
...
\StringTok{    }\KeywordTok{scale\_y\_continuous}\NormalTok{(}\DataTypeTok{name=}\StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
                       \DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ crime, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ burglary, }\DataTypeTok{y =}\NormalTok{ motor\_vehicle\_theft, }
           \DataTypeTok{size=}\NormalTok{population}\OperatorTok{/}\DecValTok{100000}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{color =} \StringTok{"blue"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_label}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ state), }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale\_x\_continuous}\NormalTok{(}\DataTypeTok{name=}\StringTok{"Burglaries per 100,000 population"}\NormalTok{, }
                       \DataTypeTok{limits=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary))) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale\_y\_continuous}\NormalTok{(}\DataTypeTok{name=}\StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
                       \DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft))) }\OperatorTok{+}
...
\StringTok{    }\NormalTok{ggrepel}\OperatorTok{::}\KeywordTok{geom\_label\_repel}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ state), }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{mean}\NormalTok{(WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Mean.TemperatureF)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{mean}\NormalTok{(WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Min.TemperatureF)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{mean}\NormalTok{(WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Max.TemperatureF)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{PrecipitationIn[}\DecValTok{1}\OperatorTok{:}\DecValTok{50}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{mean}\NormalTok{(WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Max.TemperatureF[}
\OperatorTok{+}\StringTok{                              }\NormalTok{WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{CloudCover }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{4} \OperatorTok{\&}\StringTok{ }
\OperatorTok{+}\StringTok{                              }\NormalTok{WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Max.Humidity }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{85}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{TotalGDP \textless{}{-}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{gdpPercap }\OperatorTok{*}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{pop}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{str}\NormalTok{(gapminder)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{rm}\NormalTok{(gapminder)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{library}\NormalTok{(gapminder)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp \textless{}{-}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp }\OperatorTok{*}\StringTok{ }\DecValTok{12}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder \textless{}{-}}\StringTok{ }\KeywordTok{within}\NormalTok{(gapminder, lifeExp \textless{}{-}}\StringTok{ }\NormalTok{lifeExp }\OperatorTok{*}\StringTok{ }\DecValTok{12}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{median}\NormalTok{(gm}\OperatorTok{$}\NormalTok{lifeExp[gm}\OperatorTok{$}\NormalTok{continent }\OperatorTok{==}\StringTok{ "Africa"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{median}\NormalTok{(gm}\OperatorTok{$}\NormalTok{lifeExp[gm}\OperatorTok{$}\NormalTok{continent }\OperatorTok{==}\StringTok{ "Asia"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{median}\NormalTok{(gm}\OperatorTok{$}\NormalTok{lifeExp[gm}\OperatorTok{$}\NormalTok{continent }\OperatorTok{==}\StringTok{ "Europe"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{median}\NormalTok{(gm}\OperatorTok{$}\NormalTok{lifeExp[gm}\OperatorTok{$}\NormalTok{continent }\OperatorTok{==}\StringTok{ "Americas"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{median}\NormalTok{(gm}\OperatorTok{$}\NormalTok{lifeExp[gm}\OperatorTok{$}\NormalTok{continent }\OperatorTok{==}\StringTok{ "Oceania"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{dbar \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried }\OperatorTok{{-}}\StringTok{ }\NormalTok{corn}\OperatorTok{$}\NormalTok{regular)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{n \textless{}{-}}\StringTok{ }\KeywordTok{length}\NormalTok{(corn}\OperatorTok{$}\NormalTok{regular)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{S\_d \textless{}{-}}\StringTok{ }\KeywordTok{sd}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried }\OperatorTok{{-}}\StringTok{ }\NormalTok{corn}\OperatorTok{$}\NormalTok{regular)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{t\_obs \textless{}{-}}\StringTok{ }\NormalTok{dbar}\OperatorTok{/}\NormalTok{(S\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n))}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{t\_obs}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{paired\_t}\NormalTok{(}\DataTypeTok{x1 =}\NormalTok{ corn}\OperatorTok{$}\NormalTok{kiln\_dried, }\DataTypeTok{x2 =}\NormalTok{ corn}\OperatorTok{$}\NormalTok{regular)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{cl =} \FloatTok{0.99}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{+}\StringTok{         }\NormalTok{pval \textless{}{-}}\StringTok{ }\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\KeywordTok{pt}\NormalTok{(tstat, n}\DecValTok{{-}1}\NormalTok{)}
\OperatorTok{+}\StringTok{         }\NormalTok{margin \textless{}{-}}\StringTok{ }\KeywordTok{qt}\NormalTok{(cl, n}\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\NormalTok{s\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n)}
\OperatorTok{+}\StringTok{         }\NormalTok{lcl \textless{}{-}}\StringTok{ }\NormalTok{dbar }\OperatorTok{{-}}\StringTok{ }\NormalTok{margin}
\OperatorTok{+}\StringTok{         }\NormalTok{ucl \textless{}{-}}\StringTok{ }\OtherTok{Inf}
...
\OperatorTok{+}\StringTok{         }\NormalTok{pval \textless{}{-}}\StringTok{ }\KeywordTok{pt}\NormalTok{(tstat, n}\DecValTok{{-}1}\NormalTok{)}
\OperatorTok{+}\StringTok{         }\NormalTok{margin \textless{}{-}}\StringTok{ }\KeywordTok{qt}\NormalTok{(cl, n}\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\NormalTok{s\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n)}
\OperatorTok{+}\StringTok{         }\NormalTok{lcl \textless{}{-}}\StringTok{ }\OperatorTok{{-}}\OtherTok{Inf}
\OperatorTok{+}\StringTok{         }\NormalTok{ucl \textless{}{-}}\StringTok{ }\NormalTok{dbar }\OperatorTok{+}\StringTok{ }\NormalTok{margin}
\OperatorTok{+}\StringTok{     }\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{alternative =} \StringTok{"less"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\CommentTok{\#access columns directly}
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{var}\FloatTok{.1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{class}\NormalTok{(mu}\OperatorTok{@}\NormalTok{data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{dim}\NormalTok{(mu}\OperatorTok{@}\NormalTok{data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{head}\NormalTok{(mu}\OperatorTok{@}\NormalTok{data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{proj4string}\NormalTok{(mu)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mu \textless{}{-}}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(mu, }\KeywordTok{CRS}\NormalTok{(}\StringTok{"+proj=longlat +datum=WGS84"}\NormalTok{))}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{proj4string}\NormalTok{(mu)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{min}\NormalTok{(plots}\OperatorTok{$}\NormalTok{stems\_ha)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{plots}\FloatTok{.10}\NormalTok{k \textless{}{-}}\StringTok{ }\NormalTok{plots[plots}\OperatorTok{$}\NormalTok{stems\_ha }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{10000}\NormalTok{,]}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\KeywordTok{min}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k}\OperatorTok{$}\NormalTok{stems\_ha)     }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{plots}\OperatorTok{$}\NormalTok{diameter\_in \textless{}{-}}\StringTok{ }\NormalTok{plots}\OperatorTok{$}\NormalTok{diameter\_cm}\OperatorTok{/}\FloatTok{2.54}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\KeywordTok{head}\NormalTok{(plots)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mu}\FloatTok{.10}\NormalTok{k \textless{}{-}}\StringTok{ }\NormalTok{mu[mu}\OperatorTok{$}\NormalTok{mu\_id }\OperatorTok{\%in\%}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{over}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k, mu)}\OperatorTok{$}\NormalTok{mu\_id),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{i \textless{}{-}}\StringTok{ }\KeywordTok{over}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k, mu)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{ii \textless{}{-}}\StringTok{ }\NormalTok{i}\OperatorTok{$}\NormalTok{mu\_id}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iii \textless{}{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(ii)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iv \textless{}{-}}\StringTok{ }\NormalTok{mu}\OperatorTok{$}\NormalTok{mu\_id }\OperatorTok{\%in\%}\StringTok{ }\NormalTok{iii}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{v \textless{}{-}}\StringTok{ }\NormalTok{mu[iv,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{hikes \textless{}{-}}\StringTok{ }\NormalTok{roads[roads}\OperatorTok{$}\NormalTok{type }\OperatorTok{\%in\%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Trail"}\NormalTok{, }\StringTok{"Winter"}\NormalTok{, }\StringTok{"Gravel"}\NormalTok{),]}
\OperatorTok{\textgreater{}}\StringTok{  }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{hikes.pts \textless{}{-}}\StringTok{ }\KeywordTok{as}\NormalTok{(hikes, }\StringTok{"SpatialPointsDataFrame"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{srtm.sp \textless{}{-}}\StringTok{ }\KeywordTok{as}\NormalTok{(srtm, }\StringTok{"SpatialPixelsDataFrame"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{hikes.pts}\OperatorTok{$}\NormalTok{srtm \textless{}{-}}\StringTok{ }\KeywordTok{over}\NormalTok{(hikes.pts, srtm.sp)}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{basemap \textless{}{-}}\StringTok{ }\KeywordTok{get\_map}\NormalTok{(}\DataTypeTok{location=}\NormalTok{mu.centroid, }\DataTypeTok{zoom=}\DecValTok{14}\NormalTok{, }\DataTypeTok{maptype =} \StringTok{"terrain"}\NormalTok{, }\DataTypeTok{source =} \StringTok{"google"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{color.vals \textless{}{-}}\StringTok{ }\NormalTok{srtm}\OperatorTok{@}\NormalTok{data}\OperatorTok{@}\NormalTok{values[}\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(hikes.pts)]}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\KeywordTok{ggmap}\NormalTok{(basemap) }\OperatorTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mu.ag}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\KeywordTok{row.names}\NormalTok{(mu.ag)}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{mu.ag.f \textless{}{-}}\StringTok{ }\KeywordTok{fortify}\NormalTok{(mu.ag)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{mu.srtm \textless{}{-}}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(srtm.sp, }\DataTypeTok{by=}\NormalTok{mu,}
...
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{mu.srtm}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\KeywordTok{row.names}\NormalTok{(mu.srtm)}
\OperatorTok{\textgreater{}}\StringTok{ }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{mu.srtm.f \textless{}{-}}\StringTok{ }\KeywordTok{fortify}\NormalTok{(mu.srtm)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{histogram \textless{}{-}}\StringTok{ }\KeywordTok{renderPlot}\NormalTok{(\{}
    
    \ControlFlowTok{if}\NormalTok{(input}\OperatorTok{$}\NormalTok{sexInput }\OperatorTok{!=}\StringTok{ "B"}\NormalTok{)\{}
\NormalTok{      subset.names.df \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(names.df, Sex }\OperatorTok{==}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{sexInput)}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{      subset.names.df \textless{}{-}}\StringTok{ }\NormalTok{names.df}
\NormalTok{    \}}
    
\NormalTok{    ages \textless{}{-}}\StringTok{ }\NormalTok{subset.names.df}\OperatorTok{$}\NormalTok{Age}
    
    \CommentTok{\# draw the histogram with the specified 20 bins}
    \KeywordTok{hist}\NormalTok{(ages, }\DataTypeTok{col =} \StringTok{\textquotesingle{}darkgray\textquotesingle{}}\NormalTok{, }\DataTypeTok{border =} \StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{)}
\NormalTok{  \})}
...
We see that Michigan has 151 state park campgrounds, and our data frame contains 19 variables. Let's create a Shiny app UI in which the user selects desired campground specifications, and the app displays the list of resulting campgrounds and their location on a map. The complete Shiny \texttt{app.R} is provided in the ``CampsitesMI'' directory in ``shiny\_chapter\_code.zip.'' Start out by running the application to see how it works. Examine the example code and how it relates to the application that you are running. The following sections detail each of the app's components.

\hypertarget{michigan-campgrounds-ui}{%
\subsection{Michigan Campgrounds UI}\label{michigan-campgrounds-ui}}

First, let's look at the structure of the page. Similar to our first application, we again use a \texttt{fluidPage} layout with title panel and sidebar. The sidebar contains a sidebar panel and a main panel. Our sidebar panel has three user input widgets:

\begin{itemize}
\tightlist
\item
  \texttt{sliderInput}: Allows user to specify a range of campsites desired in their campground. Since the maximum number of campsites in any Michigan state park campground is 411, 420 was chosen as the maximum.
\item
  \texttt{selectInput}: Allows user to select what type of campsites they want. To get the entire list of camp types, we used the data frame, \texttt{sites}, loaded at the beginning of the script.
\item
  \texttt{checkboxInput}: Allows the user to see only campgrounds with ADA sites available.
\end{itemize}
...
\hypertarget{michigan-campgrounds-server-logic}{%
\subsection{Michigan Campgrounds Server Logic}\label{michigan-campgrounds-server-logic}}

In creating our \texttt{server} variable, we have two functions that fill in our output elements:

\begin{itemize}
\tightlist
\item
  \texttt{renderText}: Creates a character string of HTML code to print the bulleted list of available sites.
\item
  \texttt{renderPlot}: Creates a \texttt{ggplot2} map of Michigan with campground markers.
\end{itemize}

Note that both of these functions contain identical subsetting of the \texttt{sites} data frame into the smaller \texttt{sites1} data frame (see below). As you can see from the code, we use the three inputs from the application to subset the data: \texttt{rangeNum} from the slider widget, \texttt{type} from the dropdown menu, and \texttt{ada} from the checkbox.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sites1 \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(sites, }
\NormalTok{                  TOTAL\_SITE }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{rangeNum[}\DecValTok{1}\NormalTok{] }\OperatorTok{\&}\StringTok{  }
\StringTok{                  }\NormalTok{TOTAL\_SITE }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{rangeNum[}\DecValTok{2}\NormalTok{] }\OperatorTok{\&}\StringTok{  }
\StringTok{                  }\NormalTok{Camp\_type }\OperatorTok{==}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{type }\OperatorTok{\&}\StringTok{   }
\StringTok{                  }\ControlFlowTok{if}\NormalTok{(input}\OperatorTok{$}\NormalTok{ada)\{ ADA\_SITES }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{ \} }\ControlFlowTok{else}\NormalTok{ \{ADA\_SITES }\OperatorTok{\textgreater{}=}\StringTok{ }\DecValTok{0}\NormalTok{\}}
\NormalTok{                )}
\end{Highlighting}
\end{Shaded}

\hypertarget{adding-leaflet-to-shiny}{%
\section{Adding Leaflet to Shiny}\label{adding-leaflet-to-shiny}}

\href{https://rstudio.github.io/leaflet}{Leaflet} can be easily incorporated in Shiny apps (See Chapter \ref{sp} of this text to learn more about spatial data). In the Michigan Campgrounds example code, we used \texttt{plotOutput} and \texttt{renderPlot} to put a plot widget in our Shiny app. Similarly, in this code, we will use \texttt{leafletOutput} and \texttt{renderLeaflet} to add Leaflet widgets to our app. Run the Shiny app in the \texttt{CampsitesMI\_Leaflet} directory. What are the differences between the plot widget in this app and the plot widget in the previous app (using \texttt{ggplot2})?

Our code inside \texttt{renderLeaflet} is displayed below. As a reminder from our previous use of Leaflet, we can use the \texttt{magrittr} package's pipe operator, \texttt{\%\textgreater{}\%}, to add properties to our Leaflet plot.
In the \texttt{addCircleMarkers} function, you can see that we used the \texttt{mapply} function to apply HTML code to each of the markers. The HTML code simply prints the site name and number of sites within each marker label. The \texttt{else} statement serves the purpsose that if our subset, \texttt{sites1}, is empty, we render a map centered on Lansing, MI.
...
\NormalTok{output}\OperatorTok{$}\NormalTok{plot1 \textless{}{-}}\StringTok{ }\KeywordTok{renderLeaflet}\NormalTok{(\{}
...
\StringTok{                      }\ControlFlowTok{if}\NormalTok{(input}\OperatorTok{$}\NormalTok{ada)\{ ADA\_SITES }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{ \} }\ControlFlowTok{else}\NormalTok{ \{ADA\_SITES }\OperatorTok{\textgreater{}=}\StringTok{ }\DecValTok{0}\NormalTok{\})}
    ...
    \ControlFlowTok{if}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(sites1) }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
      \KeywordTok{leaflet}\NormalTok{(sites1) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{addTiles}\NormalTok{()  }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{        }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{lng =} \OperatorTok{\textasciitilde{}}\NormalTok{Long, }\DataTypeTok{lat =} \OperatorTok{\textasciitilde{}}\NormalTok{Lat, }
                         ...
                         \DataTypeTok{label =} \KeywordTok{mapply}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x,y) \{}
                           \KeywordTok{HTML}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{\textquotesingle{}\textless{}em\textgreater{}\%s\textless{}/em\textgreater{}\textless{}br\textgreater{}\%s site(s)\textquotesingle{}}\NormalTok{, }
                                        \KeywordTok{htmlEscape}\NormalTok{(x), }
                                        \KeywordTok{htmlEscape}\NormalTok{(y)))\}, }
\NormalTok{                           sites1}\OperatorTok{$}\NormalTok{FACILITY, sites1}\OperatorTok{$}\NormalTok{TOTAL\_SITE}
\NormalTok{                           )}
\NormalTok{                         )}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
        \KeywordTok{leaflet}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{addTiles}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}
\StringTok{        }\KeywordTok{setView}\NormalTok{( }\FloatTok{{-}84.5555}\NormalTok{, }\FloatTok{42.7325}\NormalTok{,   }\DataTypeTok{zoom =} \DecValTok{7}\NormalTok{)}
\NormalTok{    \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{Pima.tr}\OperatorTok{$}\NormalTok{diabetes \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{dim}\NormalTok{(Pima.tr)[}\DecValTok{1}\NormalTok{])}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{Pima.tr}\OperatorTok{$}\NormalTok{diabetes[Pima.tr}\OperatorTok{$}\NormalTok{type }\OperatorTok{==}\StringTok{ "Yes"}\NormalTok{] \textless{}{-}}\StringTok{ }\DecValTok{1}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{head}\NormalTok{(Pima.tr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{table}\NormalTok{(diabetes.predict}\FloatTok{.1}\NormalTok{, Pima.te}\OperatorTok{$}\NormalTok{type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{length}\NormalTok{(diabetes.predict}\FloatTok{.1}\NormalTok{[diabetes.predict}\FloatTok{.1} \OperatorTok{==}\StringTok{ }\NormalTok{Pima.te}\OperatorTok{$}\NormalTok{type])}\OperatorTok{/}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{table}\NormalTok{(diabetes.predict}\FloatTok{.2}\NormalTok{, Pima.te}\OperatorTok{$}\NormalTok{type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{length}\NormalTok{(diabetes.predict}\FloatTok{.2}\NormalTok{[diabetes.predict}\FloatTok{.2} \OperatorTok{==}\StringTok{ }\NormalTok{Pima.te}\OperatorTok{$}\NormalTok{type])}\OperatorTok{/}
\OperatorTok{+}\StringTok{   }\KeywordTok{dim}\NormalTok{(Pima.te)[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{1}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{2}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{3}\NormalTok{]}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{head}\NormalTok{(class.predictions)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{table}\NormalTok{(class.predictions, iris.test}\OperatorTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{min}\NormalTok{(knnExample}\OperatorTok{$}\NormalTok{x1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{max}\NormalTok{(knnExample}\OperatorTok{$}\NormalTok{x1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{min}\NormalTok{(knnExample}\OperatorTok{$}\NormalTok{x2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{max}\NormalTok{(knnExample}\OperatorTok{$}\NormalTok{x2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{sd}\NormalTok{(iris.train}\OperatorTok{$}\NormalTok{Petal.Width)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{sd}\NormalTok{(iris.train}\OperatorTok{$}\NormalTok{Petal.Length) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{email1[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{email1 \textless{}{-}}\StringTok{ }\KeywordTok{scan}\NormalTok{(u.email, }\DataTypeTok{what =} \StringTok{"character"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{length}\NormalTok{(email1)}
\end{Highlighting}
\end{Shaded}
...
You will notice that the \texttt{scan} function ignored blank lines in the file. If it is important to preserve blank lines, the argument \texttt{blank.lines.skip\ =\ FALSE} can be supplied to \texttt{scan}.
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{coin\_toss \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{n=}\DecValTok{10}\NormalTok{, }\DataTypeTok{iter =} \DecValTok{500}\NormalTok{)\{}
\OperatorTok{+}\StringTok{   }\KeywordTok{require}\NormalTok{(ggplot2)}
\OperatorTok{+}\StringTok{   }\NormalTok{df \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{numheads =} \KeywordTok{numeric}\NormalTok{(iter))}
\OperatorTok{+}\StringTok{   }\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{iter) \{}
\OperatorTok{+}\StringTok{     }\NormalTok{df}\OperatorTok{$}\NormalTok{numheads[i] \textless{}{-}}\StringTok{ }\KeywordTok{rbinom}\NormalTok{(}\DecValTok{1}\NormalTok{, n, }\FloatTok{0.5}\NormalTok{)}
\OperatorTok{+}\StringTok{     }\ControlFlowTok{if}\NormalTok{(i }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{5}\NormalTok{) \{}
...
\OperatorTok{+}\StringTok{   }\KeywordTok{geom\_histogram}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\OperatorTok{+}\StringTok{ }\NormalTok{\}}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{coin\_toss}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{substr}\NormalTok{(x, }\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{) \textless{}{-}}\StringTok{ "$\#\&"}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{x}
\end{Highlighting}
\end{Shaded}
...
Unit: nanoseconds
  ...
  sum(x)   982  1012  1139   1044  1084    7250   100
 sumC(x)  2277  2413 12791   2483  2577  991563   100
 sumR(x) 27732 27884 56833  27987 28404 2769522   100
\end{verbatim}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-318-1.pdf}
...
\includegraphics[width=1\linewidth]{bookdown_files/figure-latex/unnamed-chunk-332-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{table}\NormalTok{(cedarWax}\OperatorTok{$}\NormalTok{Vocalization\_type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{newCedarWax \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(cedarWax, cedarWax}\OperatorTok{$}\NormalTok{Recording\_ID }\OperatorTok{\%in\%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{313682}\NormalTok{, }\DecValTok{313683}\NormalTok{, }\DecValTok{313684}\NormalTok{, }\DecValTok{321881}\NormalTok{, }\DecValTok{329907}\NormalTok{, }\DecValTok{361006}\NormalTok{))}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{quer\_xc}\NormalTok{(}\DataTypeTok{X =}\NormalTok{ newCedarWax)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(}\StringTok{"figures/sampleAutodetec.jpg"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{params}\OperatorTok{$}\NormalTok{Recording\_ID \textless{}{-}}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{\textquotesingle{}.*{-}([0{-}9]+).*\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{1\textquotesingle{}}\NormalTok{, params}\OperatorTok{$}\NormalTok{sound.files) }
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{newCedarWax}\OperatorTok{$}\NormalTok{Recording\_ID \textless{}{-}}\StringTok{ }\KeywordTok{as.character}\NormalTok{(newCedarWax}\OperatorTok{$}\NormalTok{Recording\_ID) }
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{finalData \textless{}{-}}\StringTok{ }\KeywordTok{inner\_join}\NormalTok{(params, newCedarWax) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\CommentTok{\# Remove the non{-}numeric variables and then run the pca }
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{pca \textless{}{-}}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ finalData[, }\KeywordTok{sapply}\NormalTok{(finalData, is.numeric)], }\DataTypeTok{scale. =} \OtherTok{TRUE}\NormalTok{) }
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{score \textless{}{-}}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(pca[[}\DecValTok{5}\NormalTok{]]) }
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{ID \textless{}{-}}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(finalData}\OperatorTok{$}\NormalTok{Recording\_ID) }
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ score, }\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(PC1, PC2)) }\OperatorTok{+}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Recording\_ID, }\DataTypeTok{shape =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Country))  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
...
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{        }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris}\OperatorTok{$}\NormalTok{Sepal.Length))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iris.setosa \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "setosa"}\NormalTok{, ]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iris.versicolor \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{, ]}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iris.virginica \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{, ]}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{        }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{1}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{2}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{        }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\OperatorTok{\textgreater{}}\StringTok{ }\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species))) \{}
\OperatorTok{+}\StringTok{   }\NormalTok{curr.species \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[i], ]}
\OperatorTok{+}\StringTok{   }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(curr.species}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{curr.species}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =}\NormalTok{ i)}
\OperatorTok{+}\StringTok{ }\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species, }\DataTypeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{        }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "setosa"}\NormalTok{], }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "setosa"}\NormalTok{], }\DataTypeTok{pch =} \DecValTok{17}\NormalTok{, }\DataTypeTok{col =} \DecValTok{1}\NormalTok{, }\DataTypeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{range}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{ylim =} \KeywordTok{range}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Width), }\DataTypeTok{xlab =} \StringTok{"Sepal Length"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Sepal Width"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{lines}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{], }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{], }\DataTypeTok{pch =} \DecValTok{18}\NormalTok{, }\DataTypeTok{col =} \DecValTok{2}\NormalTok{, }\DataTypeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{lines}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{], }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{], }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =} \DecValTok{3}\NormalTok{, }\DataTypeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{        }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{+}\StringTok{      }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)))}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{+}\StringTok{      }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)))}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{1}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{symbols}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
\OperatorTok{+}\StringTok{      }\DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }
\OperatorTok{+}\StringTok{      }\DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
\OperatorTok{+}\StringTok{      }\DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
\OperatorTok{+}\StringTok{      }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }
...
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{1}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{text}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{labels=}\NormalTok{crime}\OperatorTok{$}\NormalTok{state, }\DataTypeTok{cex=}\FloatTok{0.9}\NormalTok{, }\DataTypeTok{font=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{hist}\NormalTok{(Newcomb}\OperatorTok{$}\NormalTok{Time)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{hist}\NormalTok{(Newcomb}\OperatorTok{$}\NormalTok{Time, }\DataTypeTok{breaks =} \DecValTok{30}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Histogram"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Time"}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{col =} \StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-370-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{counts}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gender.counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Gender, StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gender.counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Gender, StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{, }\DataTypeTok{beside =} \OtherTok{TRUE}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{india \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(gapminder, country }\OperatorTok{==}\StringTok{ "India"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gdp.india \textless{}{-}}\StringTok{ }\NormalTok{india}\OperatorTok{$}\NormalTok{gdpPercap}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{names}\NormalTok{(gdp.india) \textless{}{-}}\StringTok{ }\NormalTok{india}\OperatorTok{$}\NormalTok{year}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gdp.india, }\DataTypeTok{xlab =} \StringTok{"Year"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"GDP Per Capita"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"India\textquotesingle{}s per{-}capita GDP"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"steelblue2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-376-1.pdf}
...
\hypertarget{section}{%
\section{2.3.4}\label{section}}

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{a \textless{}{-}}\StringTok{ }\NormalTok{(}\KeywordTok{exp}\NormalTok{(}\DecValTok{14}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{log10}\NormalTok{(}\DecValTok{8}\NormalTok{)) }\OperatorTok{*}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{b \textless{}{-}}\StringTok{ }\KeywordTok{log}\NormalTok{(}\DecValTok{4}\NormalTok{) }\OperatorTok{{-}}\StringTok{ }\NormalTok{(}\DecValTok{5} \OperatorTok{*}\StringTok{ }\DecValTok{10}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{a }\OperatorTok{/}\StringTok{ }\NormalTok{b}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{tree.sp[}\KeywordTok{length}\NormalTok{(tree.sp) }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{my.weights[my.weights }\OperatorTok{==}\StringTok{ }\DecValTok{12}\NormalTok{] \textless{}{-}}\StringTok{ }\OtherTok{NA}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{sd}\NormalTok{(my.weights, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{sim.vals \textless{}{-}}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{10000}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{hist}\NormalTok{(sim.vals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ alc.dat, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ alc.drinks, }\DataTypeTok{y =}\NormalTok{ alc.weights)) }\OperatorTok{+}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{col =} \StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, }\DataTypeTok{size =} \DecValTok{2}\NormalTok{, }\DataTypeTok{shape =} \StringTok{"square"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Number of Drinks"}\NormalTok{, }
\OperatorTok{+}\StringTok{        }\DataTypeTok{y =} \StringTok{"Weight"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{apply}\NormalTok{(WeatherKLAN2014Full[,}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\DecValTok{19}\NormalTok{, }\DecValTok{21}\NormalTok{, }\DecValTok{23}\NormalTok{)], }\DecValTok{2}\NormalTok{, sd, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{apply}\NormalTok{(iris[, }\DecValTok{{-}5}\NormalTok{], }\DecValTok{2}\NormalTok{, median)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{separate}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ data.birds, }\DataTypeTok{col =}\NormalTok{ recordingInfo, }\DataTypeTok{sep =} \StringTok{"{-}"}\NormalTok{,}
\OperatorTok{+}\StringTok{ }	 \DataTypeTok{into =} \KeywordTok{c}\NormalTok{(}\StringTok{"site"}\NormalTok{, }\StringTok{"year"}\NormalTok{, }\StringTok{"month"}\NormalTok{, }\StringTok{"day"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{select}\NormalTok{(gm, }\KeywordTok{contains}\NormalTok{(}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{gm }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{==}\StringTok{ \textquotesingle{}Afghanistan\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{select}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"year"}\NormalTok{, }\StringTok{"lifeExp"}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(lifeExp))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{iris }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{s.p.ratio =}\NormalTok{ Sepal.Length }\OperatorTok{/}\StringTok{ }\NormalTok{Petal.Length) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{group\_by}\NormalTok{(Species) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean.ratio =} \KeywordTok{mean}\NormalTok{(s.p.ratio)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(mean.))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{FtoK \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(F) \{}
\OperatorTok{+}\StringTok{   }\NormalTok{K \textless{}{-}}\StringTok{ }\NormalTok{((F }\OperatorTok{{-}}\StringTok{ }\DecValTok{32}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{5} \OperatorTok{/}\StringTok{ }\DecValTok{9}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\FloatTok{273.15}
\OperatorTok{+}\StringTok{   }\KeywordTok{return}\NormalTok{(K)}
\OperatorTok{+}\StringTok{ }\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{a[a }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{falsePositives \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{40}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(falsePositives)) \{}
\OperatorTok{+}\StringTok{   }\NormalTok{knn\_Pima \textless{}{-}}\StringTok{ }\KeywordTok{knn}\NormalTok{(Pima.tr[,}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{5}\NormalTok{)], Pima.te[,}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{5}\NormalTok{)], Pima.tr[,}\DecValTok{8}\NormalTok{], }\DataTypeTok{k =}\NormalTok{ i, }\DataTypeTok{prob=}\OtherTok{TRUE}\NormalTok{)}
\OperatorTok{+}\StringTok{   }\NormalTok{falsePositives[i] \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(knn\_Pima, Pima.te[,}\DecValTok{8}\NormalTok{])[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{]}
\OperatorTok{+}\StringTok{ }\NormalTok{\}}
\OperatorTok{\textgreater{}}\StringTok{ }\CommentTok{\# Using graphics}
\ErrorTok{\textgreater{}}\StringTok{ }\KeywordTok{plot}\NormalTok{(falsePositives, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"k"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"\# of False Positives"}\NormalTok{)}
\OperatorTok{\textgreater{}}\StringTok{ }\CommentTok{\# Using ggplot2}
\ErrorTok{\textgreater{}}\StringTok{ }\NormalTok{dat \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{k =} \DecValTok{1}\OperatorTok{:}\DecValTok{40}\NormalTok{, falsePositives)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dat, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ k, }\DataTypeTok{y =}\NormalTok{ falsePositives)) }\OperatorTok{+}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{"\# of False Positives"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{section-12}{%
\section{11.3.3}\label{section-12}}

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{unlist}\NormalTok{(}\KeywordTok{strsplit}\NormalTok{(strings, }\DataTypeTok{split =} \StringTok{\textquotesingle{}[{-}|.]\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\hypertarget{section-13}{%
\section{11.3.5}\label{section-13}}

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{library}\NormalTok{(wordcloud)}
\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{md.data.frame \textless{}{-}}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(moby\_dick\_word\_table)}
\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{wordcloud}\NormalTok{(md.data.frame}\OperatorTok{$}\NormalTok{moby\_dick, md.data.frame}\OperatorTok{$}\NormalTok{Freq, }\DataTypeTok{max.words =} \DecValTok{500}\NormalTok{, }\DataTypeTok{colors =} \KeywordTok{rainbow}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DataTypeTok{random.color =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
