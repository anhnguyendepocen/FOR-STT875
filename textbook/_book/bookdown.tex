...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fertility \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{fertility.rate[WorldBank}\OperatorTok{$}\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{1960}\NormalTok{]}
\NormalTok{lifeexp \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{life.expectancy[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pop \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{population[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
\NormalTok{region \textless{}{-}}\StringTok{ }\NormalTok{WorldBank}\OperatorTok{$}\NormalTok{region[WorldBank}\OperatorTok{$}\NormalTok{year}\OperatorTok{==}\DecValTok{1960}\NormalTok{]}
\NormalTok{pop[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mpgHpLinMod}\OperatorTok{$}\NormalTok{residuals}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mode}\NormalTok{(temporaryList}\OperatorTok{$}\NormalTok{first)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{healthData[healthData}\OperatorTok{$}\NormalTok{Gender }\OperatorTok{==}\StringTok{ "female"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{healthData[healthData}\OperatorTok{$}\NormalTok{Weight }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{190}\NormalTok{, }\DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WorldBank1971 \textless{}{-}}\StringTok{ }\NormalTok{WorldBank[WorldBank}\OperatorTok{$}\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{1971}\NormalTok{, ]}
\KeywordTok{dim}\NormalTok{(WorldBank1971)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate[}\DecValTok{1}\OperatorTok{:}\DecValTok{25}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate[}\DecValTok{1}\OperatorTok{:}\DecValTok{25}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WorldBank1971 \textless{}{-}}\StringTok{ }\NormalTok{WorldBank1971[}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(WorldBank1971}\OperatorTok{$}\NormalTok{fertility.rate),]}
\KeywordTok{dim}\NormalTok{(WorldBank1971)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{PrecipitationIn[}\DecValTok{1}\OperatorTok{:}\DecValTok{50}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Max.TemperatureF[}
\NormalTok{                             WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{CloudCover }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{4} \OperatorTok{\&}\StringTok{ }
\StringTok{                             }\NormalTok{WeatherKLAN2014Full}\OperatorTok{$}\NormalTok{Max.Humidity }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{85}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gapminder}\OperatorTok{$}\NormalTok{TotalGDP \textless{}{-}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{gdpPercap }\OperatorTok{*}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{pop}
\KeywordTok{str}\NormalTok{(gapminder)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp \textless{}{-}}\StringTok{ }\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp }\OperatorTok{*}\StringTok{ }\DecValTok{12}
\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gapminder \textless{}{-}}\StringTok{ }\KeywordTok{within}\NormalTok{(gapminder, lifeExp \textless{}{-}}\StringTok{ }\NormalTok{lifeExp }\OperatorTok{*}\StringTok{ }\DecValTok{12}\NormalTok{)}
\NormalTok{gapminder}\OperatorTok{$}\NormalTok{lifeExp[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dbar \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried }\OperatorTok{{-}}\StringTok{ }\NormalTok{corn}\OperatorTok{$}\NormalTok{regular)}
\NormalTok{n \textless{}{-}}\StringTok{ }\KeywordTok{length}\NormalTok{(corn}\OperatorTok{$}\NormalTok{regular)}
\NormalTok{S\_d \textless{}{-}}\StringTok{ }\KeywordTok{sd}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried }\OperatorTok{{-}}\StringTok{ }\NormalTok{corn}\OperatorTok{$}\NormalTok{regular)}
\NormalTok{t\_obs \textless{}{-}}\StringTok{ }\NormalTok{dbar}\OperatorTok{/}\NormalTok{(S\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n))}
\NormalTok{t\_obs}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paired\_t}\NormalTok{(}\DataTypeTok{x1 =}\NormalTok{ corn}\OperatorTok{$}\NormalTok{kiln\_dried, }\DataTypeTok{x2 =}\NormalTok{ corn}\OperatorTok{$}\NormalTok{regular)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{cl =} \FloatTok{0.99}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        margin \textless{}{-}}\StringTok{ }\KeywordTok{qt}\NormalTok{(cl, n}\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\NormalTok{s\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n)}
\NormalTok{        lcl \textless{}{-}}\StringTok{ }\NormalTok{dbar }\OperatorTok{{-}}\StringTok{ }\NormalTok{margin}
\NormalTok{        ucl \textless{}{-}}\StringTok{ }\OtherTok{Inf}
\NormalTok{    \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(alternative }\OperatorTok{==}\StringTok{ "less"}\NormalTok{)\{}
\NormalTok{        pval \textless{}{-}}\StringTok{ }\KeywordTok{pt}\NormalTok{(tstat, n}\DecValTok{{-}1}\NormalTok{)}
\NormalTok{        margin \textless{}{-}}\StringTok{ }\KeywordTok{qt}\NormalTok{(cl, n}\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\NormalTok{s\_d}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n)}
\NormalTok{        lcl \textless{}{-}}\StringTok{ }\OperatorTok{{-}}\OtherTok{Inf}
\NormalTok{        ucl \textless{}{-}}\StringTok{ }\NormalTok{dbar }\OperatorTok{+}\StringTok{ }\NormalTok{margin}
\NormalTok{    \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{alternative =} \StringTok{"less"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paired\_t}\NormalTok{(corn}\OperatorTok{$}\NormalTok{kiln\_dried, corn}\OperatorTok{$}\NormalTok{regular, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'print': argument "b" is missing, with no default
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#access columns directly}
\NormalTok{df}\OperatorTok{$}\NormalTok{var}\FloatTok{.1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{min}\NormalTok{(plots}\OperatorTok{$}\NormalTok{stems\_ha)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plots}\FloatTok{.10}\NormalTok{k \textless{}{-}}\StringTok{ }\NormalTok{plots[plots}\OperatorTok{$}\NormalTok{stems\_ha }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{10000}\NormalTok{,]}

\KeywordTok{min}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k}\OperatorTok{$}\NormalTok{stems\_ha)     }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plots}\OperatorTok{$}\NormalTok{diameter\_in \textless{}{-}}\StringTok{ }\NormalTok{plots}\OperatorTok{$}\NormalTok{diameter\_cm}\OperatorTok{/}\FloatTok{2.54}

\KeywordTok{head}\NormalTok{(plots)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu}\FloatTok{.10}\NormalTok{k \textless{}{-}}\StringTok{ }\NormalTok{mu[mu}\OperatorTok{$}\NormalTok{mu\_id }\OperatorTok{\%in\%}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{over}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k, mu)}\OperatorTok{$}\NormalTok{mu\_id),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{i \textless{}{-}}\StringTok{ }\KeywordTok{over}\NormalTok{(plots}\FloatTok{.10}\NormalTok{k, mu)}
\NormalTok{ii \textless{}{-}}\StringTok{ }\NormalTok{i}\OperatorTok{$}\NormalTok{mu\_id}
\NormalTok{iii \textless{}{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(ii)}
\NormalTok{iv \textless{}{-}}\StringTok{ }\NormalTok{mu}\OperatorTok{$}\NormalTok{mu\_id }\OperatorTok{\%in\%}\StringTok{ }\NormalTok{iii}
\NormalTok{v \textless{}{-}}\StringTok{ }\NormalTok{mu[iv,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hikes \textless{}{-}}\StringTok{ }\NormalTok{roads[roads}\OperatorTok{$}\NormalTok{type }\OperatorTok{\%in\%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Trail"}\NormalTok{, }\StringTok{"Winter"}\NormalTok{, }\StringTok{"Gravel"}\NormalTok{),]}
 
\NormalTok{hikes.pts \textless{}{-}}\StringTok{ }\KeywordTok{as}\NormalTok{(hikes, }\StringTok{"SpatialPointsDataFrame"}\NormalTok{)}
\NormalTok{srtm.sp \textless{}{-}}\StringTok{ }\KeywordTok{as}\NormalTok{(srtm, }\StringTok{"SpatialPixelsDataFrame"}\NormalTok{)}

\NormalTok{hikes.pts}\OperatorTok{$}\NormalTok{srtm \textless{}{-}}\StringTok{ }\KeywordTok{over}\NormalTok{(hikes.pts, srtm.sp)}

\NormalTok{basemap \textless{}{-}}\StringTok{ }\KeywordTok{get\_map}\NormalTok{(}\DataTypeTok{location=}\NormalTok{mu.centroid, }\DataTypeTok{zoom=}\DecValTok{14}\NormalTok{, }\DataTypeTok{maptype =} \StringTok{"terrain"}\NormalTok{, }\DataTypeTok{source =} \StringTok{"google"}\NormalTok{)}

\NormalTok{color.vals \textless{}{-}}\StringTok{ }\NormalTok{srtm}\OperatorTok{@}\NormalTok{data}\OperatorTok{@}\NormalTok{values[}\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(hikes.pts)]}

\KeywordTok{ggmap}\NormalTok{(basemap) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{data=}\KeywordTok{as.data.frame}\NormalTok{(hikes.pts),}
               \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ coords.x1, }\DataTypeTok{y =}\NormalTok{ coords.x2, }\DataTypeTok{color =}\NormalTok{ color.vals)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale\_color\_gradient}\NormalTok{(}\DataTypeTok{low=}\StringTok{"green"}\NormalTok{, }\DataTypeTok{high=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{color =} \StringTok{"Hiking trail elevation}\CharTok{\textbackslash{}n}\StringTok{(m above sea level)"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu.ag}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\KeywordTok{row.names}\NormalTok{(mu.ag)}

\NormalTok{mu.ag.f \textless{}{-}}\StringTok{ }\KeywordTok{fortify}\NormalTok{(mu.ag)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu.srtm \textless{}{-}}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(srtm.sp, }\DataTypeTok{by=}\NormalTok{mu,}
                     \DataTypeTok{FUN=}\ControlFlowTok{function}\NormalTok{(x)\{}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{var}\NormalTok{(x))\})}

\NormalTok{mu.srtm}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\KeywordTok{row.names}\NormalTok{(mu.srtm)}

\NormalTok{mu.srtm.f \textless{}{-}}\StringTok{ }\KeywordTok{fortify}\NormalTok{(mu.srtm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Pima.tr}\OperatorTok{$}\NormalTok{diabetes \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{dim}\NormalTok{(Pima.tr)[}\DecValTok{1}\NormalTok{])}
\NormalTok{Pima.tr}\OperatorTok{$}\NormalTok{diabetes[Pima.tr}\OperatorTok{$}\NormalTok{type }\OperatorTok{==}\StringTok{ "Yes"}\NormalTok{] \textless{}{-}}\StringTok{ }\DecValTok{1}
\KeywordTok{head}\NormalTok{(Pima.tr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(diabetes.predict}\FloatTok{.1}\NormalTok{, Pima.te}\OperatorTok{$}\NormalTok{type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(diabetes.predict}\FloatTok{.1}\NormalTok{[diabetes.predict}\FloatTok{.1} \OperatorTok{==}\StringTok{ }\NormalTok{Pima.te}\OperatorTok{$}\NormalTok{type])}\OperatorTok{/}
\StringTok{  }\KeywordTok{dim}\NormalTok{(Pima.te)[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(diabetes.predict}\FloatTok{.2}\NormalTok{, Pima.te}\OperatorTok{$}\NormalTok{type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(diabetes.predict}\FloatTok{.2}\NormalTok{[diabetes.predict}\FloatTok{.2} \OperatorTok{==}\StringTok{ }\NormalTok{Pima.te}\OperatorTok{$}\NormalTok{type])}\OperatorTok{/}
\StringTok{  }\KeywordTok{dim}\NormalTok{(Pima.te)[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{1}\NormalTok{]}
\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{2}\NormalTok{]}
\NormalTok{class.predictions[class.predictions }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[}\DecValTok{3}\NormalTok{]}
\KeywordTok{head}\NormalTok{(class.predictions)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coin\_toss \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{n=}\DecValTok{10}\NormalTok{, }\DataTypeTok{iter =} \DecValTok{500}\NormalTok{)\{}
  \KeywordTok{require}\NormalTok{(ggplot2)}
\NormalTok{  df \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{numheads =} \KeywordTok{numeric}\NormalTok{(iter))}
  \ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{iter) \{}
\NormalTok{    df}\OperatorTok{$}\NormalTok{numheads[i] \textless{}{-}}\StringTok{ }\KeywordTok{rbinom}\NormalTok{(}\DecValTok{1}\NormalTok{, n, }\FloatTok{0.5}\NormalTok{)}
    \ControlFlowTok{if}\NormalTok{(i }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{5}\NormalTok{) \{}
      \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The number of HEADS out of"}\NormalTok{, n, }\StringTok{"tosses is"}\NormalTok{, df}\OperatorTok{$}\NormalTok{numheads[i]))\}}
\NormalTok{  \}}
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ numheads)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_histogram}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Number of HEADS in"}\NormalTok{, n, }\StringTok{"tosses"}\NormalTok{))}
\NormalTok{\}}
\KeywordTok{coin\_toss}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{coin\_toss}\NormalTok{(}\DataTypeTok{n =} \DecValTok{25}\NormalTok{, }\DataTypeTok{iter=}\DecValTok{1000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{substr}\NormalTok{(x, }\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{) \textless{}{-}}\StringTok{ "$\#\&"}
\NormalTok{x}
\end{Highlighting}
\end{Shaded}
...
Unit: microseconds
  ...
  sum(x)  1.037  1.074  1.276  1.114  1.154   14.67
 sumC(x)  2.392  2.561 15.084  2.643  2.806 1194.37
 sumR(x) 29.385 29.536 76.613 29.663 30.037 4469.90
 neval
   100
   100
   100
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(cedarWax}\OperatorTok{$}\NormalTok{Vocalization\_type)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{params}\OperatorTok{$}\NormalTok{Recording\_ID \textless{}{-}}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{\textquotesingle{}.*{-}([0{-}9]+).*\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{1\textquotesingle{}}\NormalTok{, params}\OperatorTok{$}\NormalTok{sound.files) }
\NormalTok{newCedarWax}\OperatorTok{$}\NormalTok{Recording\_ID \textless{}{-}}\StringTok{ }\KeywordTok{as.character}\NormalTok{(newCedarWax}\OperatorTok{$}\NormalTok{Recording\_ID) }
\NormalTok{finalData \textless{}{-}}\StringTok{ }\KeywordTok{inner\_join}\NormalTok{(params, newCedarWax) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Remove the non{-}numeric variables and then run the pca }
\NormalTok{pca \textless{}{-}}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ finalData[, }\KeywordTok{sapply}\NormalTok{(finalData, is.numeric)], }\DataTypeTok{scale. =} \OtherTok{TRUE}\NormalTok{) }
\NormalTok{score \textless{}{-}}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(pca[[}\DecValTok{5}\NormalTok{]]) }
\NormalTok{ID \textless{}{-}}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(finalData}\OperatorTok{$}\NormalTok{Recording\_ID) }
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ score, }\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(PC1, PC2)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Recording\_ID, }\DataTypeTok{shape =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Country))  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
       \DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
       \DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
       \DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris}\OperatorTok{$}\NormalTok{Sepal.Length))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris.setosa \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "setosa"}\NormalTok{, ]}
\NormalTok{iris.versicolor \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{, ]}
\NormalTok{iris.virginica \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{, ]}
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
       \DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{1}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{2}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
       \DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{))}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species))) \{}
\NormalTok{  curr.species \textless{}{-}}\StringTok{ }\NormalTok{iris[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ }\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)[i], ]}
  \KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(curr.species}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{curr.species}\OperatorTok{$}\NormalTok{Sepal.Length), }\DataTypeTok{col =}\NormalTok{ i)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
     \DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }
     \DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
     \DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
     ...
     \DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
     \DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
     \DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }
     \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
     ...
     \DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
     \DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
     \DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{axes =} \OtherTok{FALSE}\NormalTok{, }
     \DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }
     \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)))}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{symbols}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
     \DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }
     \DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
     \DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
     \DataTypeTok{las =} \DecValTok{1}\NormalTok{, }
     \DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }
     \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft)), }
     \DataTypeTok{circles =}\NormalTok{ crime}\OperatorTok{$}\NormalTok{population, }
     \DataTypeTok{inches =} \DecValTok{1}\OperatorTok{/}\DecValTok{5}\NormalTok{, }\DataTypeTok{axes =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{bg=}\StringTok{"steelblue2"}\NormalTok{)}
\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{1}\NormalTok{)}
\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{)}
\KeywordTok{text}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor\_vehicle\_theft, }\DataTypeTok{labels=}\NormalTok{crime}\OperatorTok{$}\NormalTok{state, }\DataTypeTok{cex=}\FloatTok{0.9}\NormalTok{, }\DataTypeTok{font=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(Newcomb}\OperatorTok{$}\NormalTok{Time)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(Newcomb}\OperatorTok{$}\NormalTok{Time, }\DataTypeTok{breaks =} \DecValTok{30}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Histogram"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Time"}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{col =} \StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\NormalTok{counts}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gender.counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Gender, StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{gender.counts \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Gender, StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{, }\DataTypeTok{beside =} \OtherTok{TRUE}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{india \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(gapminder, country }\OperatorTok{==}\StringTok{ "India"}\NormalTok{)}
\NormalTok{gdp.india \textless{}{-}}\StringTok{ }\NormalTok{india}\OperatorTok{$}\NormalTok{gdpPercap}
\KeywordTok{names}\NormalTok{(gdp.india) \textless{}{-}}\StringTok{ }\NormalTok{india}\OperatorTok{$}\NormalTok{year}
\KeywordTok{barplot}\NormalTok{(gdp.india, }\DataTypeTok{xlab =} \StringTok{"Year"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"GDP Per Capita"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"India\textquotesingle{}s per{-}capita GDP"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"steelblue2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unlist}\NormalTok{(}\KeywordTok{strsplit}\NormalTok{(strings, }\DataTypeTok{split =} \StringTok{\textquotesingle{}[{-}|.]\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{md.data.frame \textless{}{-}}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(moby\_dick\_word\_table)}
\KeywordTok{wordcloud}\NormalTok{(md.data.frame}\OperatorTok{$}\NormalTok{moby\_dick, md.data.frame}\OperatorTok{$}\NormalTok{Freq, }\DataTypeTok{max.words =} \DecValTok{500}\NormalTok{, }\DataTypeTok{colors =} \KeywordTok{rainbow}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DataTypeTok{random.color =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
